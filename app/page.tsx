      ...
      <section className="home-hero">
        ...
        <div className="home-hero-inner">
          ...
          <div className="home-ctas">
            ...
            <button className="btn xl magenta" onClick={() => router.push("/iniciar-sesion")}>
              ✦ CREAR CUENTA
            </button>
          </div>
        ...
        <div className="activity-grid">
          ...
          <div className="activity-card">
            <div className="ac-head">
              ...
              <button className="lb-link" onClick={() => router.push("/salon-fama")}>
                VER SALÓN →
              </button>
            </div>
      ...
      <section className="home-section reveal">
        ...
        <div className="pricing-grid">
          <div className="price-card">
            ...
            <button className="btn xl pulse" style={{ width: "100%" }} onClick={() => router.push("/iniciar-sesion")}>
              EMPEZAR GRATIS →
            </button>
